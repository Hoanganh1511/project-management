...
const Task = ({ task }: TaskProps) => {
  ...
  return (
    <div
      ...
      className={`rounded-mb mb-4 shadow dark:bg-dark-secondary ${isDragging ? "opacity-50" : "opacity-100"}`}
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-s3-assets.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="dark:text-neurtal-500 text-xs text-gray-500">
            ...
            <div className="flex -space-x-[6px] overflow-hidden">
              {task.assignee && (
                <Image
                  ...
                  src={`https://pm-s3-assets.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
              ...
              {task.author && (
                <Image
                  ...
                  src={`https://pm-s3-assets.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
