    ...
    <div className="flex items-center justify-between bg-white px-4 py-3 dark:bg-black dark:px-4 dark:py-3">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative flex h-min w-[200px]">
          ...
          <input
            className="border-non w-full rounded bg-gray-100 p-2 pl-9 placeholder-gray-500 focus:border-transparent focus:outline-none dark:bg-gray-700 dark:text-white dark:placeholder-white"
            type="search"
            placeholder="Search..."
          />
        </div>
      ...
      <div className="flex items-center">
        ...
        >
          {isDarkMode ? (
            <Sun className="size-6 dark:text-white" />
          ) : (
            <Moon className="size-6 dark:text-white" />
          )}
        </button>
        <Link
          href="/settings"
